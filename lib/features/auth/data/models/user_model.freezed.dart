...
abstract class $UserModelCopyWith<$Res> {
  ...
  $Res call(
      {String email,
      String name,
      @JsonKey(name: 'profile_picture') String imageProfile,
      String? password});
}
...
class _$_UserModel extends _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(email: $email, name: $name, imageProfile: $imageProfile, password: $password)';
  }
...
abstract class _UserModel extends UserModel {
  const factory _UserModel(
      ...
      @JsonKey(name: 'profile_picture') required final String imageProfile,
